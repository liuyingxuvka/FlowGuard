...
<p align="center">
  <strong>A Python toolkit for checking risky AI-agent workflow changes before they become code or release claims.</strong>
</p>
<!-- README HERO END -->

| Public release | Schema | Runtime | License |
| --- | --- | --- | --- |
| `v0.52.0` | `1.0` | Python standard library only | MIT |
