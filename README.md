...
| --- | --- | --- | --- |
| `v0.13.0` | `1.0` | Python standard library only | MIT |
...
| Skill Kernel route map | Keeps the Codex Skill as a compact router with sub-protocols for core modeling, code structure recommendation, ModelMesh, TestMesh, StructureMesh, DevelopmentProcessFlow, model-miss, conformance/adoption, long checks, and framework upgrades |
...
- a compact Skill Kernel route map with sub-protocol references for core
  modeling, code structure recommendation, ModelMesh, TestMesh, StructureMesh,
  DevelopmentProcessFlow, model-miss,
...
| Skill Kernel route map | 让 Codex Skill 保持成一个轻量 router，把 core modeling、code structure recommendation、ModelMesh、TestMesh、StructureMesh、DevelopmentProcessFlow、model-miss、conformance/adoption、long checks 和 framework upgrades 分给子协议 |
...
- 一个更轻量的 Skill Kernel 路由表，把 core modeling、code structure
  recommendation、ModelMesh、TestMesh、StructureMesh、DevelopmentProcessFlow、model-miss、
  conformance/adoption、long checks 和 framework upgrades 分给独立 reference
  protocol；
