...
| --- | --- | --- | --- |
| `v0.5.2` | `1.0` | Python standard library only | MIT |
...
| Codex Skill | Provides a `model-first-function-flow` Skill for model-first behavior, process, argument, and decision preflights |
...
| Codex Skill | 提供 `model-first-function-flow` Skill，让 Codex 在行为、流程、论证和决策预演前先建模 |
