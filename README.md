...
<p align="center">
  <strong>A finite-state workflow simulator for cross-validating software designs and high-impact process flows before action.</strong>
</p>
<!-- README HERO END -->

| Public release | Schema | Runtime | License |
| --- | --- | --- | --- |
| `v0.3.0` | `1.0` | Python standard library only | MIT |
...
FlowGuard 是一个在写代码前，或在执行高影响流程前使用的架构模拟器 / 工作流模拟器。
它不是让 AI 直接多写一点代码，而是给 AI agent 一个先模拟流程路径的环境。
