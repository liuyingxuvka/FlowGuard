...
| Skill Kernel route map | Keeps the Codex Skill as a compact router with sub-protocols for core modeling, code structure recommendation, ModelMesh, TestMesh, StructureMesh, model-miss, conformance/adoption, long checks, and framework upgrades |
...
| Skill Kernel route map | 让 Codex Skill 保持成一个轻量 router，把 core modeling、code structure recommendation、ModelMesh、TestMesh、StructureMesh、model-miss、conformance/adoption、long checks 和 framework upgrades 分给子协议 |
...
- 一个更轻量的 Skill Kernel 路由表，把 core modeling、code structure
  recommendation、ModelMesh、TestMesh、StructureMesh、model-miss、
