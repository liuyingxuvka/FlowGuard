...
| --- | --- | --- | --- |
| `v0.69.0` | `1.0` | Python standard library only | MIT |
...
The v0.69.0 candidate self-model contains an exact inventory of 51 current
...
FlowGuard v0.69.0 is source-only: the immutable Git tag is the release
