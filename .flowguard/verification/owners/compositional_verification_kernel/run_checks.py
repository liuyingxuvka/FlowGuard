...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "compositional_verification_kernel"
...
if __name__ == "__main__":
    raise SystemExit(native_main("model:compositional_verification_kernel", main))
