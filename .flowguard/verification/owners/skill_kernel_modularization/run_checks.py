...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "skill_kernel_modularization"
...
MODEL_ROOT = PROJECT_ROOT / ".flowguard" / "models" / "owners" / "skill_kernel_modularization"
...
if __name__ == "__main__":
    raise SystemExit(native_main("model:skill_kernel_modularization", _native_owner_main))
