...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "user_facing_model_diagrams"
...
if __name__ == "__main__":
    raise SystemExit(native_main("model:user_facing_model_diagrams", main))
