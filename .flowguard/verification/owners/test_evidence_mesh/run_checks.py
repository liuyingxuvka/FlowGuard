...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "test_evidence_mesh"
...
MODEL_ROOT = PROJECT_ROOT / ".flowguard" / "models" / "owners" / "test_evidence_mesh"
