...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "structure_refactor_mesh"
...
MODEL_ROOT = PROJECT_ROOT / ".flowguard" / "models" / "owners" / "structure_refactor_mesh"
...
def _native_owner_main() -> tuple:
    ...
    return native_results_from_scenario_report(
        "model:structure_refactor_mesh", report
    )


if __name__ == "__main__":
    raise SystemExit(native_main("model:structure_refactor_mesh", _native_owner_main))
