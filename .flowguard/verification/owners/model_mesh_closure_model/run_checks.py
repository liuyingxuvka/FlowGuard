...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "model_mesh_closure_model"
...
if __name__ == "__main__":
    raise SystemExit(native_main("model:model_mesh_closure_model", main))
