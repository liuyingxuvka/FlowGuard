...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "harden_ui_real_surface_validation"
...
if __name__ == "__main__":
    raise SystemExit(native_main("model:harden_ui_real_surface_validation", main))
