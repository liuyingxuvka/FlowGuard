...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "runtime_path_evidence"
...
if __name__ == "__main__":
    raise SystemExit(native_main("model:runtime_path_evidence", main))
