...
_FLOWGUARD_MODEL_ROOT = _FLOWGUARD_PROJECT_ROOT / ".flowguard" / "models" / "owners" / "architecture_reduction"
...
MODEL_ROOT = PROJECT_ROOT / ".flowguard" / "models" / "owners" / "architecture_reduction"
...
def _native_owner_main() -> tuple:
    ...
    return native_results_from_scenario_report(
        "model:architecture_reduction", report
    )


if __name__ == "__main__":
    raise SystemExit(native_main("model:architecture_reduction", _native_owner_main))
