    ...
    plan = ArchitectureReductionPlan(
        ...
        candidates=(
            ArchitectureReductionCandidate(
                ...
                primary_path_id="path:model-first-function-flow:plane-first-route-selection",
                inventory_revision="2026-07-12-plane-partition-and-facade-authority",
                owner_code_contract_id="contract:model-first-function-flow:route-guidance",
                delegates_to_code_contract_id="contract:model-first-function-flow:route-guidance",
                delegates_to_primary_path_id="path:model-first-function-flow:plane-first-route-selection",
            ...
            ArchitectureReductionCandidate(
                ...
                code_node_id="docs/agents_snippet.md and model-first-function-flow/SKILL.md",
