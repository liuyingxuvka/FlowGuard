# flowguard-helper-control-plane Specification

## Purpose
FlowGuard's helper control plane defines which routes are public owners,
delegated modes, internal feeders, data helpers, or archived surfaces. It keeps
AI-facing route discovery compact while preserving specialist helper evidence
behind the owning route that must consume it.
## Requirements
