...
Define one canonical, versioned inventory for the FlowGuard kernel and public satellite skills so membership, required control files, readiness checks, and legacy projections cannot silently drift apart.
