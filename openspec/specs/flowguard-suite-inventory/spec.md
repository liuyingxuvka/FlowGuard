# flowguard-suite-inventory Specification

## Purpose

Define the package-owned canonical consumer authority and its exact
reconciliation boundaries so public membership, files, projections, and
retired entries cannot silently drift.
...
consumer-suite authority declaring the current member ids and exact clean
