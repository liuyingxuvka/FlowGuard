# model-miss-diagnostic-evidence Specification

## Purpose
Define bounded diagnostic evidence for a model miss so FlowGuard can isolate a
small conflict and propose a non-vacuous repair without replacing the parent
model-miss review or its evidence authority.
