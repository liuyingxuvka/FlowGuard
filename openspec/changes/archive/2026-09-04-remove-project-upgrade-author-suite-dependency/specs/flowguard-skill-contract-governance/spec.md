> **Retirement preparation (2026-09-04):** This stale delta is retained only as
> exact handoff evidence. Its target requirement names are already present in
> current specs, and its removal source is absent. The official archive must use
> `--skip-specs`; do not apply, restore, or reinterpret this delta.
