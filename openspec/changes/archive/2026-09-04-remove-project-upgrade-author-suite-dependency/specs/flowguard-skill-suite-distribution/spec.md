...
> exact handoff evidence. All target requirement names are already present in
> current specs. The official archive must use `--skip-specs`; do not apply,
> restore, or reinterpret this delta.
