...
inventoried, enabled controls must have real functional chains, and source
interaction semantics must be modeled. A remaining gap is that a UI can still be
