...
The change affects `flowguard/target_system_blueprint.py`, `flowguard/self_blueprint.py`, `flowguard/self_architecture_reduction.py`, their public exports, focused tests, and the FlowGuard OpenSpec/model adoption records. It does not add a domain-specific adapter, reconstruction path, compatibility reader, or second model authority.
