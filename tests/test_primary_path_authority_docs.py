...
def test_agents_and_skill_guidance_include_primary_path_authority_policy():
    ...
    assert "visible promises" in combined
    # The compact current contract names this boundary as protected failures;
    # retired route documentation used the old "failure boundary" wording.
    assert "protected failures" in combined
    assert "alternate automatic success path" in combined
