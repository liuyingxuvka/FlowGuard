...
def behavior_ledger(path_authority):
    return BehaviorCommitmentLedger(
        ...
        expected_business_intent_ids=(INTENT_ID,),
        expected_source_surface_ids=("surface:api-submit-order",),
        ...
        source_surfaces=(
            BehaviorSourceSurface(
                ...
                source_system_id="orders-api",
                native_artifact_id="orders/api.py",
                content_fingerprint="sha256:orders-api-content",
                inventory_revision="rev-1",
                discovery_evidence_ids=("inventory:rev-1",),
                source_authority_role="normative",
                declared_semantics_fingerprint="sha256:submit-order-semantics",
