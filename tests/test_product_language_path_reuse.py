...
def behavior_ledger(*, commitments=None, surface_commitment_ids=(COMMITMENT_ID,)):
    ...
    return review_behavior_commitment_ledger(
        BehaviorCommitmentLedger(
            ...
            expected_source_surface_ids=(UI_SURFACE_ID, API_SURFACE_ID),
            source_inventory_revision=REVISION,
            source_inventory_fingerprint="sha256:download-material-source-inventory",
            source_inventory_evidence_ids=("inventory:download-material",),
            ...
            source_surfaces=(
                BehaviorSourceSurface(
                    ...
                    source_system_id="download-product",
                    native_artifact_id="ui/download-page",
                    content_fingerprint="sha256:download-page",
                    inventory_revision=REVISION,
                    discovery_evidence_ids=("inventory:download-material",),
                    declared_semantics_fingerprint="sha256:download-intent",
                ...
                BehaviorSourceSurface(
                    ...
                    source_system_id="download-product",
                    native_artifact_id="api/download-material",
                    content_fingerprint="sha256:download-api",
                    inventory_revision=REVISION,
                    discovery_evidence_ids=("inventory:download-material",),
                    declared_semantics_fingerprint="sha256:download-intent",
                    freshness_state="current",
