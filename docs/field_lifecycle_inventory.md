...
| Layer | Fields |
| --- | ---: |
| `behavior_or_contract` | 762 |
| `collection_metadata` | 1333 |
| `compatibility_or_old_path` | 56 |
| `display_or_metadata` | 231 |
| `evidence_or_decision` | 1066 |
| `unclassified` | 2545 |
...
| `agent_workflow_rehearsal` | 75 |
| `model_freshness` | 75 |
| `model_revision_set` | 73 |
| `maintenance_scan` | 70 |
| `portable_system` | 66 |
| `runtime_gateway` | 65 |
| `development_process_strategy` | 64 |
| `distribution_sync` | 63 |
| `risk_templates` | 61 |
| `structuremesh` | 61 |
| `model_authority` | 56 |
| `model_regressions` | 53 |
| `auto_split` | 52 |
| `budgeted` | 52 |
| `corpus` | 48 |
| `executable` | 48 |
| `risk_evidence_ledger` | 47 |
| `code_structure` | 44 |
| `development_process_simulator` | 43 |
| `project_adoption` | 42 |
| `template_packs` | 41 |
| `model_maturation` | 39 |
| `portable_model` | 38 |
...
| `artifact_upgrade` | `FlowGuardJsonArtifactRegistration` | `artifact_type` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `artifact_upgrade` | `FlowGuardJsonArtifactRegistration` | `version_field` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `artifact_upgrade` | `FlowGuardJsonArtifactRegistration` | `current_versions` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `artifact_upgrade` | `FlowGuardJsonArtifactRegistration` | `allowed_fields` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `artifact_upgrade` | `FlowGuardJsonArtifactRegistration` | `field_types` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `artifact_upgrade` | `FlowGuardJsonArtifactRegistration` | `required_values` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
...
| `behavior_commitment` | `BehaviorSourceSurface` | `source_system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `native_artifact_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `content_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `inventory_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `discovery_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `source_authority_role` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `declared_semantics_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `coverage_disposition` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `delegated_owner_inventory_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `delegation_relation_type` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorSourceSurface` | `native_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
...
| `behavior_commitment` | `BehaviorCommitmentLedger` | `subject_lane` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorCommitmentLedger` | `expected_source_surface_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `behavior_commitment` | `BehaviorCommitmentLedger` | `source_inventory_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorCommitmentLedger` | `source_inventory_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `behavior_commitment` | `BehaviorCommitmentLedger` | `source_inventory_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `behavior_commitment` | `BehaviorCommitmentLedger` | `require_complete_source_inventory` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `behavior_commitment` | `BehaviorCommitmentCoverageReport` | `missing_source_surface_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `behavior_commitment` | `BehaviorCommitmentCoverageReport` | `unexpected_source_surface_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
...
| `conformance` | `ConformanceReport` | `prediction_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `conformance` | `ConformanceReport` | `prediction_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `conformance` | `ConformanceReport` | `model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `conformance` | `ConformanceReport` | `observation_boundary_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `coverage_inventory` | `ExpectedCoverageItem` | `item_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `source_kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `source_role` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `source_system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `native_artifact_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `native_owner_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `content_ref` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `content_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `semantics_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `discovery_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `recommended_disposition` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageItem` | `metadata` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `coverage_inventory` | `ExpectedCoverageInventory` | `inventory_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageInventory` | `boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageInventory` | `revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageInventory` | `items` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `coverage_inventory` | `ExpectedCoverageInventory` | `discovery_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `coverage_inventory` | `ExpectedCoverageInventory` | `inventory_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageFinding` | `code` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageFinding` | `message` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `coverage_inventory` | `ExpectedCoverageFinding` | `item_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageReview` | `inventory` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `coverage_inventory` | `ExpectedCoverageReview` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
...
| `development_process_flow` | `ProcessArtifact` | `work_context_id` | `development_process_flow` | `starter` | `unclassified` | `false` |
| `development_process_flow` | `ProcessArtifact` | `work_context_adapter_id` | `development_process_flow` | `starter` | `unclassified` | `false` |
| `development_process_flow` | `ProcessArtifact` | `work_context_fingerprint` | `development_process_flow` | `internal` | `unclassified` | `false` |
| `development_process_flow` | `ProcessArtifact` | `read_only_external` | `development_process_flow` | `advanced` | `behavior_or_contract` | `true` |
...
| `development_process_flow` | `ProcessAction` | `work_context_id` | `development_process_flow` | `starter` | `unclassified` | `false` |
| `development_process_flow` | `ProcessAction` | `work_context_adapter_id` | `development_process_flow` | `starter` | `unclassified` | `false` |
| `development_process_flow` | `ProcessAction` | `work_context_fingerprint` | `development_process_flow` | `internal` | `unclassified` | `false` |
| `development_process_flow` | `ProcessAction` | `work_context_artifact_ids` | `development_process_flow` | `internal` | `collection_metadata` | `false` |
| `development_process_flow` | `ProcessAction` | `work_context_read_only` | `development_process_flow` | `internal` | `unclassified` | `false` |
...
| `development_process_flow` | `ProcessEvidence` | `revalidation_cost` | `development_process_flow` | `internal` | `unclassified` | `false` |
| `development_process_flow` | `ProcessEvidence` | `revalidation_cost_basis` | `development_process_flow` | `internal` | `unclassified` | `false` |
...
| `development_process_flow` | `DevelopmentProcessPlan` | `work_context_ids` | `development_process_flow` | `internal` | `collection_metadata` | `false` |
| `development_process_flow` | `DevelopmentProcessPlan` | `require_current_work_context` | `development_process_flow` | `starter` | `unclassified` | `false` |
| `development_process_flow` | `DevelopmentProcessPlan` | `process_optimization_reasons` | `development_process_flow` | `advanced` | `evidence_or_decision` | `false` |
| `development_process_flow` | `DevelopmentProcessPlan` | `required_process_optimization_evidence_ids` | `development_process_flow` | `starter` | `evidence_or_decision` | `false` |
...
| `development_process_flow` | `RevalidationRecommendation` | `covered_requirement_ids` | `development_process_flow` | `internal` | `collection_metadata` | `false` |
| `development_process_flow` | `RevalidationRecommendation` | `revalidation_cost` | `development_process_flow` | `internal` | `unclassified` | `false` |
| `development_process_flow` | `RevalidationRecommendation` | `revalidation_cost_basis` | `development_process_flow` | `internal` | `unclassified` | `false` |
| `development_process_flow` | `RevalidationRecommendation` | `selection_boundary` | `development_process_flow` | `internal` | `unclassified` | `false` |
...
| `development_process_flow` | `DevelopmentProcessFlowReport` | `process_optimization_status` | `development_process_flow` | `starter` | `evidence_or_decision` | `false` |
...
| `development_process_flow` | `DevelopmentProcessFlowReport` | `revalidation_optimality_boundary` | `development_process_flow` | `internal` | `unclassified` | `false` |
...
| `development_process_simulator` | `DevelopmentProcessSimulationRequest` | `process_optimization_reasons` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
...
| `development_process_simulator` | `DevelopmentProcessSimulationRequest` | `process_optimization_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
...
| `development_process_simulator` | `DevelopmentProcessModeDecision` | `route_target` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
...
| `development_process_strategy` | `ProcessOptimizationContract` | `contract_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationContract` | `terminal_outcome_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationContract` | `required_obligation_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationContract` | `required_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationContract` | `safety_constraint_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationContract` | `protected_side_effect_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationContract` | `dependency_authority_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationContract` | `execution_owner_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationContract` | `revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `candidate_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `contract_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `terminal_outcome_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `covered_obligation_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `safety_constraint_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `protected_side_effect_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `dependency_authority_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `execution_owner_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `step_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `validation_requirement_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `dependency_edges` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `stop_condition_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `diagnostic_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `execution_mode` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `dependency_isolation_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `state_isolation_evidence_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `side_effect_isolation_evidence_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `execution_owner_isolation_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `comparison_basis` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `comparison_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `applicable` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationCandidate` | `current` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `group_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `finding_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `relation_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `root_cause_claim` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `disproof_check_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `affected_obligation_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessRepairGroup` | `owner_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `repair_action_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessRepairGroup` | `required_revalidation_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `current_revalidation_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessRepairGroup` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `decision_id` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `outcome_contract` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `activation_reasons` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `candidates` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `repair_groups` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `selected_candidate_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `input_revision` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `current_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `material_evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationDecision` | `selection_rationale` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `ok` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `decision_id` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `selected_candidate_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `eligible_candidate_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `rejected_candidate_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `selected_comparison_basis` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `required_revalidation_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `finding_codes` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `development_process_strategy` | `ProcessOptimizationReport` | `summary` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
...
| `distribution_sync` | `ConsumerSuiteAuthority` | `source` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `ConsumerSuiteAuthority` | `flowguard_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `ConsumerSuiteAuthority` | `member_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `distribution_sync` | `ConsumerSuiteAuthority` | `files` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `distribution_sync` | `ConsumerSuiteAuthority` | `raw_tree_hash` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `ConsumerSuiteAuthority` | `semantic_tree_hash` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `ConsumerSuiteAuthority` | `authority_hash` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `distribution_sync` | `ConfiguredParityReport` | `root_roles` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
...
| `distribution_sync` | `DistributionReport` | `authority_hash` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `DistributionReport` | `authority_raw_tree_hash` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `DistributionReport` | `authority_semantic_tree_hash` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `distribution_sync` | `DistributionReport` | `authority_member_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
...
| `existing_model_preflight` | `ExistingModelPreflight` | `authority_required` | `existing_model_preflight` | `internal` | `unclassified` | `false` |
| `existing_model_preflight` | `ExistingModelPreflight` | `authority_status` | `existing_model_preflight` | `starter` | `evidence_or_decision` | `false` |
| `existing_model_preflight` | `ExistingModelPreflight` | `authority_snapshot_fingerprint` | `existing_model_preflight` | `internal` | `unclassified` | `false` |
| `existing_model_preflight` | `ExistingModelPreflight` | `authority_subject_revision` | `existing_model_preflight` | `internal` | `unclassified` | `false` |
| `existing_model_preflight` | `ExistingModelPreflight` | `authority_gap_ids` | `existing_model_preflight` | `advanced` | `evidence_or_decision` | `false` |
...
| `existing_model_preflight` | `ExistingModelPreflight` | `work_contexts` | `existing_model_preflight` | `internal` | `collection_metadata` | `false` |
...
| `field_lifecycle` | `FieldLifecycleRow` | `owner_id` | `field_lifecycle_mesh` | `starter` | `unclassified` | `false` |
...
| `field_lifecycle` | `FieldLifecycleRow` | `default_semantics` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `absence_semantics` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `serialization_semantics` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `privacy_classification` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `content_fingerprint` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `coverage_disposition` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `delegated_owner_id` | `field_lifecycle_mesh` | `starter` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecycleRow` | `coverage_evidence_refs` | `field_lifecycle_mesh` | `starter` | `evidence_or_decision` | `false` |
...
| `field_lifecycle` | `FieldLifecyclePlan` | `inventory_revision` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecyclePlan` | `inventory_fingerprint` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
| `field_lifecycle` | `FieldLifecyclePlan` | `discovery_evidence_ids` | `field_lifecycle_mesh` | `starter` | `evidence_or_decision` | `false` |
| `field_lifecycle` | `FieldLifecyclePlan` | `require_complete_inventory` | `field_lifecycle_mesh` | `internal` | `unclassified` | `false` |
...
| `maintenance_scan` | `MaintenanceEvidence` | `work_context_id` | `maintenance_scan_router` | `starter` | `unclassified` | `false` |
| `maintenance_scan` | `MaintenanceEvidence` | `work_context_hash` | `maintenance_scan_router` | `internal` | `unclassified` | `false` |
| `maintenance_scan` | `MaintenanceEvidence` | `work_context_read_only` | `maintenance_scan_router` | `internal` | `unclassified` | `false` |
...
| `maintenance_scan` | `MaintenanceScanPlan` | `required_work_context_ids` | `maintenance_scan_router` | `internal` | `collection_metadata` | `false` |
...
| `model_authority` | `ModelInputRef` | `path` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInputRef` | `sha256` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInputRef` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `logical_model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `model_kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `model_path` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `model_sha256` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `runner_path` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `runner_sha256` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `purpose_closure_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `subject_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelInstanceRef` | `inputs` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_authority` | `ModelInstanceRef` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `AuthorityEndpointRef` | `endpoint_kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `AuthorityEndpointRef` | `endpoint_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `AuthorityEndpointRef` | `fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `AuthorityEndpointRef` | `owner_route` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_authority` | `AuthorityEndpointRef` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelRelation` | `relation_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelRelation` | `kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelRelation` | `source` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelRelation` | `target` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelRelation` | `evidence_fingerprints` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_authority` | `ModelRelation` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `CoverageDimension` | `dimension_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `CoverageDimension` | `required_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `CoverageDimension` | `covered_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `CoverageDimension` | `excluded_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `CoverageDimension` | `unresolved_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `CoverageDimension` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `CoverageUniverse` | `boundary_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `CoverageUniverse` | `source_inventory_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `CoverageUniverse` | `dimensions` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `CoverageUniverse` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `CoverageUniverse` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `snapshot_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `subject_lane` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `lifecycle` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `subject_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `root_instance_fingerprints` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `model_instances` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `relations` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `coverage` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `owner_artifact_refs` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `unresolved_gap_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelSystemSnapshot` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `subject_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `generation` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `accepted_revision_set_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `previous_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `activation_receipt_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority` | `ModelAuthorityHead` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityFinding` | `severity` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityFinding` | `code` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityFinding` | `message` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `root` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `observed_source_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `observed_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `head_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `coverage_status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `unresolved_gap_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_authority_store` | `ModelAuthorityAuditReport` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `model_purpose` | `FailureProofBinding` | `failure_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `FailureProofBinding` | `known_bad_case_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `FailureProofBinding` | `oracle_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `model_instance_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `reusable_model_type_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `task_intent_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `guarded_purpose` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `protected_failure_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `known_good_case_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `failure_bindings` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `evidence_check_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `model_sha256` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `runner_sha256` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `declaration_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `closure_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `declaration_phase` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `adoption_scope` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_purpose` | `ModelPurposeClosure` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `model_regressions` | `ModelRegressionEntry` | `model_kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRegressionEntry` | `purpose_closure` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `model_regressions` | `ModelRunResult` | `model_instance_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRunResult` | `model_kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRunResult` | `subject_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRunResult` | `model_instance_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRunResult` | `input_inventory_fingerprint` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_regressions` | `ModelRunResult` | `input_inventory` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_regressions` | `ModelRunResult` | `purpose_closure_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRunResult` | `purpose_claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_regressions` | `ModelRunResult` | `stdout` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_regressions` | `ModelRunResult` | `stderr` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
...
| `model_regressions` | `ModelRegressionReport` | `command` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `receipt_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `receipt_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `owner_route` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `RevisionEvidenceRef` | `subject_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `obligation_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `RevisionEvidenceRef` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `current` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `eligible` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionEvidenceRef` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `replay_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `replay_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `prediction_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `prediction_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `observation_boundary_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `candidate_instance_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `PredictionReplayRef` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionMemberChange` | `member_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionMemberChange` | `operation` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionMemberChange` | `base_instance_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionMemberChange` | `candidate_instance_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `RevisionMemberChange` | `changed_element_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `RevisionMemberChange` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `revision_set_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `task_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `expected_head_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `base_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `candidate_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `members` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `affected_closure_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `affected_closure_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `changed_relation_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `changed_source_surface_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `changed_commitment_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `changed_field_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `changed_side_effect_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRevisionSet` | `changed_contract_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRevisionSet` | `changed_test_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `changed_system_property_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `required_evidence_refs` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `completed_evidence_refs` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `prediction_replay_refs` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `implementation_bundle_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `rollback_contract_fingerprint` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRevisionSet` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `decision_reason` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRevisionSet` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `receipt_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `revision_set_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `expected_head_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `previous_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `candidate_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `subject_revision` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `next_generation` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelActivationReceipt` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackEffect` | `effect_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRollbackEffect` | `kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackEffect` | `disposition` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackEffect` | `required_evidence_fingerprints` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRollbackEffect` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackContract` | `contract_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRollbackContract` | `from_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackContract` | `to_snapshot_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackContract` | `effects` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRollbackContract` | `old_snapshot_conformance_evidence_fingerprints` | `core_or_internal` | `advanced` | `compatibility_or_old_path` | `true` |
| `model_revision_set` | `ModelRollbackContract` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackReceipt` | `receipt_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `model_revision_set` | `ModelRollbackReceipt` | `contract_fingerprint` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `model_revision_set` | `ModelRollbackReceipt` | `result` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRollbackReceipt` | `completed_evidence_fingerprints` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRollbackReceipt` | `reason` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `model_revision_set` | `ModelRollbackReceipt` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `plan_detailing` | `PlanDetailSource` | `work_context_id` | `plan_detailing_compiler` | `starter` | `unclassified` | `false` |
| `plan_detailing` | `PlanDetailSource` | `work_context_adapter_id` | `plan_detailing_compiler` | `starter` | `unclassified` | `false` |
| `plan_detailing` | `PlanDetailSource` | `work_context_fingerprint` | `plan_detailing_compiler` | `internal` | `unclassified` | `false` |
| `plan_detailing` | `PlanDetailSource` | `work_context_artifact_ids` | `plan_detailing_compiler` | `internal` | `collection_metadata` | `false` |
| `plan_detailing` | `PlanDetailSource` | `work_context_read_only` | `plan_detailing_compiler` | `internal` | `unclassified` | `false` |
...
| `plan_detailing` | `PlanDetailStep` | `work_context_id` | `plan_detailing_compiler` | `starter` | `unclassified` | `false` |
| `plan_detailing` | `PlanDetailStep` | `work_context_adapter_id` | `plan_detailing_compiler` | `starter` | `unclassified` | `false` |
| `plan_detailing` | `PlanDetailStep` | `work_context_fingerprint` | `plan_detailing_compiler` | `internal` | `unclassified` | `false` |
| `plan_detailing` | `PlanDetailStep` | `work_context_artifact_ids` | `plan_detailing_compiler` | `internal` | `collection_metadata` | `false` |
| `plan_detailing` | `PlanDetailStep` | `work_context_read_only` | `plan_detailing_compiler` | `internal` | `unclassified` | `false` |
...
| `plan_detailing` | `PlanDetailValidation` | `work_context_id` | `plan_detailing_compiler` | `starter` | `unclassified` | `false` |
...
| `plan_detailing` | `PlanDetail` | `process_optimization_reasons` | `plan_detailing_compiler` | `advanced` | `evidence_or_decision` | `false` |
| `plan_detailing` | `PlanDetail` | `required_process_optimization_evidence_ids` | `plan_detailing_compiler` | `starter` | `evidence_or_decision` | `false` |
...
| `portable_checker` | `PortableTraceStep` | `transition_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableTraceStep` | `source_state` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableTraceStep` | `input_symbol` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableTraceStep` | `output_symbol` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableTraceStep` | `target_state` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableTrace` | `initial_state` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableTrace` | `steps` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableTrace` | `terminal_state` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableFinding` | `finding_id` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `portable_checker` | `PortableFinding` | `message` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `portable_checker` | `PortableFinding` | `obligation_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableFinding` | `state_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableFinding` | `transition_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableFinding` | `details` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableExecutionReport` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `portable_checker` | `PortableExecutionReport` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_checker` | `PortableExecutionReport` | `model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_checker` | `PortableExecutionReport` | `traces` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableExecutionReport` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `portable_checker` | `PortableExecutionReport` | `blockers` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableExecutionReport` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_checker` | `PortableCheckReport` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `portable_checker` | `PortableCheckReport` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_checker` | `PortableCheckReport` | `model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_checker` | `PortableCheckReport` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `portable_checker` | `PortableCheckReport` | `counterexamples` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableCheckReport` | `checked_obligation_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_checker` | `PortableCheckReport` | `blockers` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableCheckReport` | `skipped_checks` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableCheckReport` | `residual_risk` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_checker` | `PortableCheckReport` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `PortableState` | `state_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableState` | `payload` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `PortableTransition` | `transition_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTransition` | `source_state` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTransition` | `input_symbol` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTransition` | `output_symbol` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTransition` | `target_state` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTransition` | `label` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `portable_model` | `PortableInvariant` | `invariant_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableInvariant` | `forbidden_state_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableInvariant` | `description` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `portable_model` | `PortableTemporalObligation` | `obligation_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTemporalObligation` | `kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `PortableTemporalObligation` | `trigger_state_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTemporalObligation` | `target_state_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTemporalObligation` | `transition_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableTemporalObligation` | `max_steps` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `PortableTemporalObligation` | `description` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `portable_model` | `PortableModel` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `PortableModel` | `states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableModel` | `transitions` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableModel` | `initial_state_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableModel` | `terminal_state_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableModel` | `invariants` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableModel` | `temporal_obligations` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `PortableModel` | `assumptions` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_model` | `PortableModel` | `guarantees` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_model` | `PortableModel` | `conflicts` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_model` | `PortableModel` | `metadata` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `PortableModel` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `RefinementBinding` | `parent_model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `RefinementBinding` | `child_model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `RefinementBinding` | `state_mapping` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `RefinementBinding` | `transition_mapping` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `RefinementBinding` | `allowed_stutter_transition_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_model` | `RefinementBinding` | `parent_model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `RefinementBinding` | `child_model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_model` | `RefinementBinding` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemComponentRef` | `component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemComponentRef` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemComponentRef` | `model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemDependency` | `dependency_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemDependency` | `source_component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemDependency` | `target_component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemDependency` | `kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventPort` | `port_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventPort` | `component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventPort` | `direction` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventPort` | `event_type` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_system` | `SystemEventBinding` | `binding_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventBinding` | `producer_port_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventBinding` | `consumer_port_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventBinding` | `delivery` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventBinding` | `ordering` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemEventBinding` | `identity_mapping` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemEventBinding` | `queue_component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemSharedResource` | `resource_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemSharedResource` | `owner_component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemSharedResource` | `reader_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemSharedResource` | `writer_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemTransitionRef` | `component_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemTransitionRef` | `transition_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_system` | `SystemStep` | `step_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemStep` | `transition_refs` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_system` | `SystemStep` | `relation_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemStep` | `code_targets` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemStatePattern` | `pattern_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemStatePattern` | `component_states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_system` | `SystemProperty` | `property_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemProperty` | `owner_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemProperty` | `kind` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemProperty` | `trigger_pattern_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemProperty` | `target_pattern_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemProperty` | `step_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemProperty` | `max_steps` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemDefinition` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemDefinition` | `components` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `dependencies` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `ports` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `bindings` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `resources` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `steps` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `state_patterns` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_system` | `PortableSystemDefinition` | `properties` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `unresolved_dependency_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemDefinition` | `discovery_evidence_id` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `portable_system` | `PortableSystemDefinition` | `scheduler_policy` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemDefinition` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemCompositionRequest` | `request_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemCompositionRequest` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemCompositionRequest` | `system_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `SystemCompositionRequest` | `changed_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemCompositionRequest` | `selected_property_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemCompositionRequest` | `requested_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemCompositionRequest` | `environment_guarantees` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `SystemCompositionRequest` | `max_states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `portable_system` | `SystemCompositionRequest` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemSlice` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemSlice` | `system_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemSlice` | `request_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `portable_system` | `PortableSystemSlice` | `included_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemSlice` | `excluded_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemSlice` | `selected_property_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `portable_system` | `PortableSystemSlice` | `blockers` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
...
| `release_verification` | `ReleaseVerificationReceipt` | `phase` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `tag` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `checks` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `parent_receipt_id` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `parent_receipt_fingerprint` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `validation_input_manifest_fingerprint` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `release_tree_manifest_fingerprint` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `commit` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `upstream_receipt_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `artifact_paths` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `release_url` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `release_verification` | `ReleaseVerificationReceipt` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `replay` | `ReplayInput` | `external_input` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `replay` | `ReplayInput` | `function_name` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `replay` | `ReplayInput` | `function_input` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
...
| `self_maintenance` | `SelfMaintenancePlan` | `required_work_context_ids` | `flowguard_self_maintenance` | `internal` | `collection_metadata` | `false` |
| `self_maintenance` | `SelfMaintenancePlan` | `work_context_hashes` | `flowguard_self_maintenance` | `internal` | `collection_metadata` | `false` |
...
| `skill_suite` | `SkillSuiteMemberReport` | `repository_role` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `summary_report` | `FlowGuardFindingLedgerEntry` | `finding_id` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `summary_report` | `FlowGuardFindingLedgerEntry` | `source_finding_code` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `summary_report` | `FlowGuardFindingLedgerEntry` | `source_subject_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `summary_report` | `FlowGuardFindingLedgerEntry` | `evidence_ids` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
...
| `system_composition` | `SystemTraceStep` | `system_step_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `SystemTraceStep` | `compiled_transition_id` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemTraceStep` | `component_transition_ids` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemTraceStep` | `before_component_states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemTraceStep` | `after_component_states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemTraceStep` | `relation_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemTraceStep` | `code_targets` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCounterexample` | `initial_component_states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemCounterexample` | `steps` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCounterexample` | `terminal_component_states` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemCompositionReport` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `system_composition` | `SystemCompositionReport` | `system_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `SystemCompositionReport` | `system_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `SystemCompositionReport` | `request_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `SystemCompositionReport` | `slice_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `SystemCompositionReport` | `compiled_model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `SystemCompositionReport` | `stages` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `component_reports` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `system_composition` | `SystemCompositionReport` | `contract_report` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemCompositionReport` | `system_report` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `system_composition` | `SystemCompositionReport` | `counterexamples` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `blockers` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `system_composition` | `SystemCompositionReport` | `explored_state_count` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `SystemCompositionReport` | `frontier_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `involved_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `affected_component_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `residual_risk` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `system_composition` | `SystemCompositionReport` | `claim_boundary` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `_Compilation` | `model` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `_Compilation` | `state_vectors` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `_Compilation` | `transition_metadata` | `core_or_internal` | `internal` | `behavior_or_contract` | `true` |
| `system_composition` | `_Compilation` | `complete` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `system_composition` | `_Compilation` | `frontier_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `task_local_model` | `TaskModelVersion` | `version_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelVersion` | `model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelVersion` | `artifact_ref` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelVersion` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `prediction_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `task_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `scenario_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `model_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `expected_trace` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `falsifier` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `observation_boundary_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `trace_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskPredictionSnapshot` | `prediction_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `replay_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `task_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `prediction_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `prediction_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `model_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `report_fingerprint` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `observation_boundary_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `task_local_model` | `TaskReplayEvidence` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `revision_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `task_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `model_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `base_model` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `candidate_model` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `prediction_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `task_local_model` | `TaskModelRevision` | `mismatch_summary` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `task_local_model` | `TaskModelRevision` | `changed_model_elements` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `task_local_model` | `TaskModelRevision` | `required_replay_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `task_local_model` | `TaskModelRevision` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `task_local_model` | `TaskModelRevision` | `completed_replay_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `task_local_model` | `TaskModelRevision` | `decision_reason` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `task_local_model` | `TaskModelRevision` | `schema` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `HardPredicate` | `key` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `HardPredicate` | `operator` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `HardPredicate` | `expected` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePack` | `template_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePack` | `version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePack` | `template` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePack` | `predicates` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePack` | `priority` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePack` | `base` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePack` | `composable` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePack` | `owned_fields` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePack` | `required_parameters` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePackManifest` | `manifest_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackManifest` | `version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackManifest` | `templates` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePackManifest` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackManifest` | `manifest_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `ManifestValidation` | `manifest_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `ManifestValidation` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `manifest_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `context_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `matched_template_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `selected_template_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `disposition` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackSelectionReceipt` | `selection_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `manifest_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `selection_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `parameter_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `selected_template_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `rendered_template` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `schema_version` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `TemplatePackInstanceReceipt` | `instance_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `ReceiptValidation` | `status` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `template_packs` | `ReceiptValidation` | `expected_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `ReceiptValidation` | `observed_digest` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `template_packs` | `ReceiptValidation` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `template_packs` | `ValidatedTemplatePackRegistry` | `manifest` | `core_or_internal` | `internal` | `unclassified` | `false` |
...
| `testmesh` | `TestPartitionItem` | `coverage_disposition` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestPartitionItem` | `native_owner_id` | `test_mesh_maintenance` | `starter` | `unclassified` | `false` |
| `testmesh` | `TestPartitionItem` | `required_native_evidence_ids` | `test_mesh_maintenance` | `starter` | `evidence_or_decision` | `false` |
| `testmesh` | `TestPartitionItem` | `planning_context_only` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
...
| `testmesh` | `TestSuiteEvidence` | `planned_count` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestSuiteEvidence` | `executed_count` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestSuiteEvidence` | `failed_count` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestSuiteEvidence` | `not_run_count` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestSuiteEvidence` | `diagnostic_campaign_id` | `test_mesh_maintenance` | `starter` | `unclassified` | `false` |
| `testmesh` | `TestSuiteEvidence` | `diagnostic_boundary` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestSuiteEvidence` | `finding_ids` | `test_mesh_maintenance` | `starter` | `evidence_or_decision` | `false` |
...
| `testmesh` | `TestMeshPlan` | `coverage_inventory_id` | `test_mesh_maintenance` | `starter` | `unclassified` | `false` |
| `testmesh` | `TestMeshPlan` | `coverage_inventory_revision` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestMeshPlan` | `coverage_inventory_fingerprint` | `test_mesh_maintenance` | `internal` | `unclassified` | `false` |
| `testmesh` | `TestMeshPlan` | `coverage_inventory_evidence_ids` | `test_mesh_maintenance` | `starter` | `evidence_or_decision` | `false` |
| `testmesh` | `TestMeshPlan` | `planning_context_ids` | `test_mesh_maintenance` | `internal` | `collection_metadata` | `false` |
...
| `ui_structure` | `UIObservedSurfaceItem` | `content_fingerprint` | `ui_flow_structure` | `internal` | `unclassified` | `false` |
...
| `ui_structure` | `UIObservedSurfaceInventory` | `inventory_fingerprint` | `ui_flow_structure` | `internal` | `unclassified` | `false` |
| `ui_structure` | `UIObservedSurfaceInventory` | `discovery_evidence_ids` | `ui_flow_structure` | `starter` | `evidence_or_decision` | `false` |
| `ui_structure` | `UIObservedSurfaceInventory` | `require_complete_inventory` | `ui_flow_structure` | `internal` | `unclassified` | `false` |
...
| `work_context` | `WorkContextArtifact` | `artifact_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextArtifact` | `artifact_role` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextArtifact` | `source_ref` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextArtifact` | `content_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextArtifact` | `size` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `context_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `adapter_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `native_work_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `native_owner_id` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `project_root` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `context_root` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `artifacts` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `work_context` | `WorkContext` | `required_artifact_roles` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `work_context` | `WorkContext` | `behavior_source_surface_ids` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `work_context` | `WorkContext` | `subject_lane` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `read_only` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `current` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `context_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContext` | `native_metadata` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `work_context` | `WorkContextFinding` | `code` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextFinding` | `message` | `core_or_internal` | `internal` | `display_or_metadata` | `false` |
| `work_context` | `WorkContextFinding` | `source_ref` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextReview` | `context` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `WorkContextReview` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `work_context` | `ProjectWorkContextReview` | `project_root` | `core_or_internal` | `internal` | `unclassified` | `false` |
| `work_context` | `ProjectWorkContextReview` | `contexts` | `core_or_internal` | `internal` | `collection_metadata` | `false` |
| `work_context` | `ProjectWorkContextReview` | `findings` | `core_or_internal` | `internal` | `evidence_or_decision` | `false` |
| `work_context` | `ProjectWorkContextReview` | `declaration_fingerprint` | `core_or_internal` | `internal` | `unclassified` | `false` |
