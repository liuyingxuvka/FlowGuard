...
def default_flowguard_route_profiles() -> tuple[RouteProfile, ...]:
    ...
    profiles = (
        ...
        RouteProfile(
            ...
            "An explicit reuse/publication request or a proven stable cross-project pattern needs strict template handling.",
            ("risk query", "public templates", "local template root"),
            ("template matches", "reuse review", "candidate harvest report"),
            "risk_template_library",
            route_handoffs("model_maturation_loop", "development_process_flow"),
            "risk_template_library",
        ...
        RouteProfile(
            "architecture_reduction",
            "Existing modeled implementation may be retained, equivalently contracted, or intentionally retired with complete current proof.",
        ...
        RouteProfile(
            "development_process_flow",
            "Development-process and post-change scan owner for staged edits, changed or skipped work, validation freshness, install sync, shadow sync, or peer writes.",
        ...
        RouteProfile(
            ...
            "flowguard_closure_contract",
            route_handoffs("development_process_flow"),
            "flowguard_closure_contract",
        ...
        RouteProfile(
            ...
            ("ContractExhaustion case contributions", "ModelMaturation result", "updated bindings", "coverage receipt", "closure evidence"),
            "model_miss_review",
            route_handoffs("contract_exhaustion_mesh", "model_maturation_loop", "model_test_alignment", "risk_evidence_ledger", "flowguard_closure_contract"),
            "model_miss_review",
        ...
        RouteProfile(
            ...
            SELF_MAINTENANCE_ROUTE,
            route_handoffs("development_process_flow", "flowguard_closure_contract"),
            SELF_MAINTENANCE_ROUTE,
            "",
            "",
            route_role=ROUTE_ROLE_INTERNAL_FEEDER,
