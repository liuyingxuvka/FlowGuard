...
def default_flowguard_route_profiles() -> tuple[RouteProfile, ...]:
    ...
    return (
        ...
        RouteProfile(
            ...
            "Model obligations need direct binding to owner code contracts and tests.",
            ("model obligations", "code contracts", "test evidence"),
            ("binding rows", "coverage gaps", "boundary observations"),
            "model_test_alignment",
        ...
        RouteProfile(
            ...
            "Large, slow, stale, background, or release-only validation needs child evidence.",
            ("parent suite", "child suites", "freshness evidence"),
            ("parent/child test mesh", "result artifacts", "scoped gaps"),
            "test_mesh_maintenance",
        ...
        RouteProfile(
            ...
            "Three or more models, large models, or stale child evidence need parent/child governance.",
            ("parent model", "child models", "partition items"),
            ("mesh evidence", "reattachment status", "affected siblings"),
            "model_mesh_maintenance",
        ...
        RouteProfile(
            ...
            "Final done/release/production confidence needs risk-to-proof accounting.",
            ("risk rows", "proof refs", "route evidence"),
            ("confidence decision", "unsupported claims", "proof gaps"),
            "risk_evidence_ledger",
        ...
        RouteProfile(
            "model_miss_review",
            "A bug, runtime failure, or post-green miss needs generalized repair evidence.",
            ("observed miss", "root cause", "same-class bad case"),
            ("defect family gate", "analogous defect scan", "closure evidence"),
            "model_miss_review",
