...
- Topology digest: states, inputs, blocks, workflow edges, state writes,
  ...
  parent/child compression, and landmark ids.
...
repeatable side effects, shared writers, broad terminal states, old/new or
schema paths, external confirmation boundaries, parent/child compression, or
local-only evidence used for release/full confidence.
