...
## Entrypoint Scope
Covers flowguard-agent-workflow-rehearsal and routed local materials only; no unrelated repos, private paths, services, publication, or release claims unless separately routed.
