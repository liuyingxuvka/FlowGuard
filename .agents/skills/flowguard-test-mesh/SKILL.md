...
## Entrypoint Scope
Covers flowguard-test-mesh plus explicitly routed local materials; no unrelated repos, private files, external services, publication, or release claims unless requested and routed.
...
## Use When
Use when the request matches flowguard-test-mesh and needs this governed workflow, materials, checks, or handoff behavior.
## Do Not Use When
