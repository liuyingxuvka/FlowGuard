...
## Entrypoint Scope
Route `field_lifecycle_mesh` (`public_owner`); owns field boundaries/projections, not downstream proof.

## Local Material Routing
After selecting the subject, read `references/field_lifecycle_mesh_protocol.md` for `FieldLifecyclePlan`, grouped leaf rows, projections, replacement policy, and handoffs.
