...
- Read `modeling_core_protocol.md` for Risk Intent, finite state/functions, `Input x State -> Set(Output x State)`, invariants, formal checks, counterexamples, scenarios, loops, implementation, and replay.
- Read `modeling_evidence_protocol.md` for lightest-mode selection, current evidence, claim boundaries, model-miss/maturation/maintenance handoffs, and completion reporting.
...
+ TemplateReuseReview + TemplateHarvestReview
...
Kernel-owned internal work includes model maturation, risk-template reuse/harvest, self-maintenance, maintenance-obligation memory, Risk Evidence Ledger, and closure-contract coordination. These are internal routes, not new public skills.
