...
## Entry Scope
Covers flowguard-existing-model-preflight and explicitly routed local materials only; no unrelated repos, private paths, external services, publication, or release claims unless separately routed.
## Runtime Binding
